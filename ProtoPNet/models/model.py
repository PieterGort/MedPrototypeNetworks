...
from models.convnext_features import convnext_tiny_13_features, convnext_tiny_26_features
...
def construct_PPNet(base_architecture, pretrained=True, img_size=224,
    ...
    proto_layer_rf_info = compute_proto_layer_rf_info_v2(img_size=img_size[0],
                                                         layer_filter_sizes=layer_filter_sizes,
                                                         layer_strides=layer_strides,
                                                         layer_paddings=layer_paddings,
                                                         prototype_kernel_size=prototype_shape[2])
    print("Prototype layer receptive field: {0}".format(proto_layer_rf_info))
